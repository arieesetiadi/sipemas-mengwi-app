...
@php
    $isEdit = isset($admin);
    $routeAction = $isEdit ? route('system.admin.update', $admin) : route('system.admin.store');
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="page-description d-flex justify-content-between align-items-center">
                        <h1>{{ $title }}</h1>
                        <a href="{{ route('system.admin.index') }}" class="btn btn-light">
            ...
            <div class="row">
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <form id="admin-form" action="{{ $routeAction }}" method="POST">
                                @csrf
                                @method($method)
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ route('system.admin.index') }}" class="btn btn-light">Batal</a>
                                </div>
                            </form>
                        </div>
                    </div>
