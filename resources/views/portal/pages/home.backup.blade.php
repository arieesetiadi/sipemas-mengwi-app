                ...
                <div class="col">
                    <div class="page-description d-flex align-items-center">
                        ...
                        <div class="page-description-actions">
                            ...
                            <a href="#" class="btn btn-warning btn-style-light"><i
            ...
            <div class="row">
                <div class="col-xl-4">
                    <div class="card widget widget-list">
                        ...
                        <div class="card-body">
                            <span class="text-muted m-b-xs d-block">showing 5 out of 23 active
                                tasks.</span>
                            ...
                            <div class="widget-payment-request-container">
                                <div class="widget-payment-request-author">
                                    ...
                                    <div class="widget-payment-request-author-info">
                                        <span class="widget-payment-request-author-name">Caio
                                            Yousuke</span>
                                ...
                                <div class="widget-payment-request-product">
                                    <div class="widget-payment-request-product-image m-r-sm">
                                        <img src="{{ asset('assets/images/other/facebook_logo.png') }}" class="mt-auto"
                                            alt="">
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="widget-popular-product-container">
                                ...
                                <div class="widget-popular-product-content">
                                    <a href="#" class="widget-popular-product-title">Banana
                                        Donut</a>
                        ...
                        <div class="card-body">
                            <div class="widget-info-container">
                                <div class="widget-info-image"
                                    style="background: url('{{ asset('assets/images/widgets/security.svg') }}')">
                                </div>
                                ...
                                <a href="#" class="btn btn-primary widget-info-action">Upgrade
                                    Now</a>
                            </div>
                        </div>
                    </div>
