...
<div class="judul">SURAT KETERANGAN MEMILIKI USAHA</div>
...
<table class="field">
    ...
    <tr><td class="kiri">NIK</td><td>: {{ $penduduk->nik }}</td></tr>
...
<p>Memang benar orang tersebut di atas, memiliki Usaha {{ $pengajuan->nama_usaha }} yang berlokasi di {{ $pengajuan->lokasi_usaha }}.</p>

<p>Demikianlah surat keterangan ini dibuat dengan sebenarnya untuk dapat dipergunakan di mana perlu.</p>
