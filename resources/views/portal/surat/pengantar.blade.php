...
<p>Orang tersebut di atas adalah benar penduduk Desa Adat Mengwi. Sehubungan dengan hal tersebut, dimohon kepada Yth. {{ $pengajuan->tujuan_instansi }} untuk dapat menerima dan menindaklanjuti yang bersangkutan dalam keperluan: {{ $pengajuan->keperluan }}.</p>
